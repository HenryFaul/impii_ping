      ...
      <div class="flex flex-wrap -mb-8 -mr-6 p-8">
        ...
        <div class="flex space-x-2 justify-center">
          <div>
            ...
            <button type="button" class="inline-block ml-2 mt-1  px-6 py-2 border-2 border-green-500 text-green-500 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
            ...
            <button type="button" class="inline-block ml-2 mt-1 px-6 py-2 border-2 border-red-600 text-red-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
              <Link  href="/sos">S.O.S</Link>
            </button>
          </div>
        </div>

        <div class="bg-yellow-100 mt-4 mb-2 rounded-lg py-5 px-6 mb-4 text-base text-yellow-700 mb-3" role="alert">
          Click on New Protection to get a protection agent or View Protection to see reserved Protection Details.
        </div>
